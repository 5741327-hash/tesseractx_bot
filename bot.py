...
def generate_ai_content(title, raw_text):
    ...
    system_prompt = (
        ...
        "Твоя задача — превратить сырой текст научной новости в увлекательный, легко читаемый пост, раскрывающий суть новости. "
        ...
        "Используй дружелюбный, но информативный тон, добавляй подходящие эмодзи и абзацы. Ответ формулируй простыми и доступными словами. "
