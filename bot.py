...
# ИЗМЕНЕНИЕ: Уменьшение лимита до 850 символов для гарантированного запаса (Лимит Telegram 1024)
MAX_POST_LENGTH = 850 
...
def generate_ai_content(title, raw_text):
    ...
    # ОБНОВЛЕНИЕ ПРОМТА: Установка лимита в 850 символов
    system_prompt = (
        ...
        "Обязательно структурируй пост, используя **полужирные заголовки** или **ключевые фразы** для выделения основных идей или выводов. Это должно улучшить читаемость. "
