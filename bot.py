...
def generate_ai_content(title, raw_text):
    ...
    system_prompt = (
        ...
        "Стиль: новости для гиков — простой язык, простыми словами, живыми словами, эмодзи."
        "Длина поста — максимум 850 символов с пробелами."

       "Обязательная структура каждого поста:"
       "1. Первая строчка — жирный хук-вопрос или громкое утверждение (начинается с эмодзи)"
       "2. Что произошло, почему это круто/странно/важно (простыми словами, живыми словами)"
       "3. Проверь: Может ли человек, далекий от науки, понять суть за 2 минуты чтения?"
