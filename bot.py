...
def generate_ai_content(title, raw_text):
    ...
    system_prompt = (
        ...
        # 3. СПОЙЛЕР
        "3. Далее идет Блок-Спойлер. Он должен быть обернут в тег <b></b> и содержать только объяснение '📌 Если просто' с бытовой аналогией, иронично, с юмором и сарказмом в стиле сериала теория большого взрыва. "
